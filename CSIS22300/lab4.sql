...
SELECT e.employee_id, e.last_name, e.department_id AS "Dept_ID from Emp", d.department_id AS "Dept_ID from Dept", d.location_id
FROM employees e, departments d
WHERE e.department_id = d.department_id;

-- 3 --

SELECT CONCAT(e.last_name, ' works for ' , manager.last_name) AS "relationship"
FROM employees e
